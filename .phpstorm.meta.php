...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.aliases.ConfigureRequestQuestions' => 'string',
            ...
            'filesystems.links./Users/fredy/Desktop/projects/project-z/public/storage' => 'string',
            'github-webhooks.signing_secret' => 'string',
            'github-webhooks.jobs.ping' => 'string',
            'github-webhooks.jobs.issues.opened' => 'string',
            'github-webhooks.model' => 'string',
            'github-webhooks.prune_webhook_calls_after_days' => 'integer',
            'github-webhooks.job' => 'string',
            'github-webhooks.profile' => 'string',
            'github-webhooks.verify_signature' => 'boolean',
            ...
            'logging.channels.webhook.driver' => 'string',
            'logging.channels.webhook.path' => 'string',
            'mail.default' => 'string',
            ...
            'services.github.webhook_url' => 'string',
...
'app.aliases.Queue','app.aliases.RateLimiter','app.aliases.Redirect','app.aliases.ConfigureRequestQuestions','app.aliases.Response',
...
'auth.passwords.users.table','auth.passwords.users.expire','auth.passwords.users.throttle','auth.password_timeout','auth.socialite.drivers',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./Users/fredy/Desktop/projects/project-z/public/storage',
'github-webhooks.signing_secret','github-webhooks.jobs.ping','github-webhooks.jobs.issues.opened','github-webhooks.model','github-webhooks.prune_webhook_calls_after_days',
'github-webhooks.job','github-webhooks.profile','github-webhooks.verify_signature','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','logging.channels.webhook.driver','logging.channels.webhook.path','mail.default',
...
'reverb.apps.apps.0.max_message_size','services.postmark.token','services.ses.key','services.ses.secret','services.ses.region',
'services.resend.key','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.google.client_id','services.google.client_secret',
'services.google.redirect','services.discord.client_id','services.discord.client_secret','services.discord.redirect','services.github.client_id',
'services.github.client_secret','services.github.redirect','services.github.webhook_url','session.driver','session.lifetime',
...
'telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify','hashing.argon.memory',
...
'sanctum.middleware.authenticate_session','sanctum.middleware.encrypt_cookies','sanctum.middleware.validate_csrf_token','webhook-client.configs.0.name','webhook-client.configs.0.signing_secret',
...
'webhook-client.configs.0.store_headers','webhook-client.configs.0.process_webhook_job','webhook-client.delete_after_days','webhook-client.add_unique_token_to_route_name','ide-helper.filename',
...
'sanctum.csrf-cookie','telescope','user.profile','dashboard','profile.onboarding',
'profile.onboarding.store','settings.edit','settings.update','settings.destroy','projects.index',
'projects.create','projects.store','projects.show','projects.edit','projects.update',
'projects.rename','projects.destroy','projects.search-users','projects.invite','projects.request',
'notifications.index','notifications.markAllAsRead','notifications.markAsRead','messages.index','messages.uploadImage',
'messages.message','messages.store','social.login','social.callback',
...
'VITE_APP_NAME','REVERB_CLIENT_HOST','REVERB_CLIENT_PORT','REVERB_CLIENT_SCHEME','REVERB_CLIENT_KEY',
...
'GOOGLE_CLIENT_ID','GOOGLE_CLIENT_SECRET','GOOGLE_REDIRECT','GITHUB_CLIENT_ID','GITHUB_CLIENT_SECRET',
'GITHUB_REDIRECT','DISCORD_CLIENT_ID','DISCORD_CLIENT_SECRET','DISCORD_REDIRECT','GITHUB_WEBHOOK_SECRET',
'GITHUB_WEBHOOK_URL',);
